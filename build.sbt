...
libraryDependencies ++= Seq(
  ...
  "com.typesafe.akka" %% "akka-http" % versions.akkaHttp withSources() withJavadoc(),
  "com.typesafe.akka" %% "akka-remote" % versions.akka withSources() withJavadoc(),
  "de.heikoseeberger" %% "akka-http-json4s" % "1.16.1" withSources() withJavadoc(),
